...
-- Vehicles (15)
INSERT INTO vehicles (id, version, entry_date, license_plate, vin, car_model_id, status, km_travelled, pending_cleaning)
VALUES
-- First day
-- Vehicles for Car Model ID 1
(1, 1, '2025-04-11', 'ABC1234', '1HGCM82633A000001', 1, 'RENTED', 25000.0, FALSE),
(2, 1, '2025-04-11', 'XYZ5678', '2T1BURHE9JC000002', 1, 'RENTED', 60000.0, FALSE),

-- Vehicles for Car Model ID 2
(3, 1, '2025-04-11', 'JKL9012', '3VWFE21C04M000003', 2, 'AVAILABLE', 120000.0, TRUE),

-- Vehicles for Car Model ID 3
(4, 1, '2025-04-11', 'DEF3456', 'WVWZZZ3CZ8E000004', 3, 'RENTED', 30000.0, FALSE),
(5, 1, '2025-04-11', 'GHI7890', '1N4AL3AP2DN000005', 3, 'AVAILABLE', 91000.0, TRUE),

-- Vehicles for Car Model ID 4
(6, 1, '2025-04-11', 'LMN2345', '5NPDH4AE7DH000006', 4, 'AVAILABLE', 47000.0, FALSE),

-- Vehicles for Car Model ID 5
(7, 1, '2025-04-11', 'PQR6789', '1FAFP34N96W000007', 5, 'AVAILABLE', 54000.0, FALSE),
(8, 1, '2025-04-11', 'STU9876', 'JHMFA16586S000008', 5, 'AVAILABLE', 23000.0, FALSE),

-- Vehicles for Car Model ID 6
(9, 1, '2025-04-11', 'VWX4321', '2HGES26751H000009', 6, 'AVAILABLE', 89000.0, TRUE),

-- Vehicles for Car Model ID 7
(10, 1, '2025-04-11', 'YZA8765', '1J4FA39S34P000010', 7, 'AVAILABLE', 12000.0, FALSE),

-- Vehicles for Car Model ID 8
(11, 1, '2025-04-11', 'BCD5432', '3D7MX48A77G000011', 8, 'AVAILABLE', 103000.0, TRUE),
(12, 1, '2025-04-11', 'EFG2198', 'KMHCT4AE0FU000012', 8, 'AVAILABLE', 48000.0, FALSE),

-- Vehicles for Car Model ID 9
(13, 1, '2025-04-11', 'HIJ3276', '5XYKT3A1XDG000013', 9, 'AVAILABLE', 37000.0, FALSE),

-- Vehicles for Car Model ID 10
(14, 1, '2025-04-11', 'KLM7645', '2T3ZF4DV4BW000014', 10, 'AVAILABLE', 51000.0, FALSE),
(15, 1, '2025-04-11', 'NOP4321', '1G1PC5SB1E000015', 10, 'AVAILABLE', 81000.0, FALSE),

-- Second day
-- Vehicles for Car Model ID 1
(16, 1, '2025-04-12', 'ABC1234', '1HGCM82633A000001', 1, 'AVAILABLE', 25050.0, FALSE),
(17, 1, '2025-04-12', 'XYZ5678', '2T1BURHE9JC000002', 1, 'RENTED', 60050.0, FALSE),

-- Vehicles for Car Model ID 2
(18, 1, '2025-04-12', 'JKL9012', '3VWFE21C04M000003', 2, 'AVAILABLE', 120000.0, TRUE),

-- Vehicles for Car Model ID 3
(19, 1, '2025-04-12', 'DEF3456', 'WVWZZZ3CZ8E000004', 3, 'RENTED', 30050.0, FALSE),
(20, 1, '2025-04-12', 'GHI7890', '1N4AL3AP2DN000005', 3, 'AVAILABLE', 91000.0, TRUE),

-- Vehicles for Car Model ID 4
(21, 1, '2025-04-12', 'LMN2345', '5NPDH4AE7DH000006', 4, 'AVAILABLE', 47000.0, FALSE),

-- Vehicles for Car Model ID 5
(22, 1, '2025-04-12', 'PQR6789', '1FAFP34N96W000007', 5, 'AVAILABLE', 54000.0, FALSE),
(23, 1, '2025-04-12', 'STU9876', 'JHMFA16586S000008', 5, 'AVAILABLE', 23000.0, FALSE),

-- Vehicles for Car Model ID 6
(24, 1, '2025-04-12', 'VWX4321', '2HGES26751H000009', 6, 'AVAILABLE', 89000.0, TRUE),

-- Vehicles for Car Model ID 7
(25, 1, '2025-04-12', 'YZA8765', '1J4FA39S34P000010', 7, 'AVAILABLE', 12000.0, FALSE),

-- Vehicles for Car Model ID 8
(26, 1, '2025-04-12', 'BCD5432', '3D7MX48A77G000011', 8, 'AVAILABLE', 103000.0, TRUE),
(27, 1, '2025-04-12', 'EFG2198', 'KMHCT4AE0FU000012', 8, 'AVAILABLE', 48000.0, FALSE),

-- Vehicles for Car Model ID 9
(28, 1, '2025-04-12', 'HIJ3276', '5XYKT3A1XDG000013', 9, 'AVAILABLE', 37000.0, FALSE),

-- Vehicles for Car Model ID 10
(29, 1, '2025-04-12', 'KLM7645', '2T3ZF4DV4BW000014', 10, 'AVAILABLE', 51000.0, FALSE),
(30, 1, '2025-04-12', 'NOP4321', '1G1PC5SB1E000015', 10, 'AVAILABLE', 81000.0, FALSE);
