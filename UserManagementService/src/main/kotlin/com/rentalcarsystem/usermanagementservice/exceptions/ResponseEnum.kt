package com.rentalcarsystem.usermanagementservice.exceptions
...
enum class ResponseEnum(
    ...
    // User errors
    USER_NOT_FOUND(4100, "User not found", HttpStatus.NOT_FOUND),
    USER_DUPLICATED(4101, "Duplicated user", HttpStatus.CONFLICT);
