...
-- Vehicles (15)
INSERT INTO vehicles (id, license_plate, vin, car_model_id, km_travelled, pending_cleaning, pending_repair)
VALUES
-- Vehicles for Car Model ID 1
(1, 'ABC1234', '1HGCM82633A000001', 1, 25000.0, FALSE, FALSE),
(2, 'XYZ5678', '2T1BURHE9JC000002', 1, 60000.0, FALSE, FALSE),

-- Vehicles for Car Model ID 2
(3, 'JKL9012', '3VWFE21C04M000003', 2, 120000.0, TRUE, TRUE),

-- Vehicles for Car Model ID 3
(4, 'DEF3456', 'WVWZZZ3CZ8E000004', 3, 30000.0, FALSE, FALSE),
(5, 'GHI7890', '1N4AL3AP2DN000005', 3, 91000.0, TRUE, TRUE),

-- Vehicles for Car Model ID 4
(6, 'LMN2345', '5NPDH4AE7DH000006', 4, 47000.0, FALSE, FALSE),

-- Vehicles for Car Model ID 5
(7, 'PQR6789', '1FAFP34N96W000007', 5, 54000.0, FALSE, FALSE),
(8, 'STU9876', 'JHMFA16586S000008', 5, 23000.0, FALSE, FALSE),

-- Vehicles for Car Model ID 6
(9, 'VWX4321', '2HGES26751H000009', 6, 89000.0, TRUE, TRUE),

-- Vehicles for Car Model ID 7
(10, 'YZA8765', '1J4FA39S34P000010', 7, 12000.0, FALSE, FALSE),

-- Vehicles for Car Model ID 8
(11, 'BCD5432', '3D7MX48A77G000011', 8, 103000.0, TRUE, TRUE),
(12, 'EFG2198', 'KMHCT4AE0FU000012', 8, 48000.0, FALSE, FALSE),

-- Vehicles for Car Model ID 9
(13, 'HIJ3276', '5XYKT3A1XDG000013', 9, 37000.0, FALSE, FALSE),

-- Vehicles for Car Model ID 10
(14, 'KLM7645', '2T3ZF4DV4BW000014', 10, 51000.0, FALSE, FALSE),
(15, 'NOP4321', '1G1PC5SB1E000015', 10, 81000.0, FALSE, FALSE);
