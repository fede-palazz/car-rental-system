...
(16, 'IERD928', '93ND9ALKG83NS9AK', 1, 'RENTED', 500.0, FALSE),
(17, 'AFRD928', '93ND9PWOD83NS9AK', 1, 'RENTED', 900.0, FALSE),
...
(4, 'DEF3456', 'WVWZZZ3CZ8E000004', 3, 'AVAILABLE', 30000.0, FALSE),
(5, 'GHI7890', '1N4AL3AP2DN000005', 3, 'IN_MAINTENANCE', 91000.0, TRUE),

-- Vehicles for Car Model ID 4
(6, 'LMN2345', '5NPDH4AE7DH000006', 4, 'AVAILABLE', 47000.0, FALSE),

-- Vehicles for Car Model ID 5
(7, 'PQR6789', '1FAFP34N96W000007', 5, 'AVAILABLE', 54000.0, FALSE),
(8, 'STU9876', 'JHMFA16586S000008', 5, 'AVAILABLE', 23000.0, FALSE),

-- Vehicles for Car Model ID 6
(9, 'VWX4321', '2HGES26751H000009', 6, 'IN_MAINTENANCE', 89000.0, TRUE),

-- Vehicles for Car Model ID 7
(10, 'YZA8765', '1J4FA39S34P000010', 7, 'AVAILABLE', 12000.0, FALSE),
(18, 'AFO3498', 'PWRD9PWO205HS9AK', 7, 'RENTED', 1000.0, FALSE),


-- Vehicles for Car Model ID 8
(11, 'BCD5432', '3D7MX48A77G000011', 8, 'AVAILABLE', 103000.0, TRUE),
(12, 'EFG2198', 'KMHCT4AE0FU000012', 8, 'RENTED', 48000.0, FALSE),

-- Vehicles for Car Model ID 9
(13, 'HIJ3276', '5XYKT3A1XDG000013', 9, 'RENTED', 37000.0, FALSE),

-- Vehicles for Car Model ID 10
(14, 'KLM7645', '2T3ZF4DV4BW000014', 10, 'RENTED', 51000.0, FALSE),
(15, 'NOP4321', '1G1PC5SB1E000015', 10, 'RENTED', 81000.0, FALSE);
