...
class ProblemDetailHandler : ResponseEntityExceptionHandler() {
    ...
    // Triggered by optimistic locking when an entity is modified concurrently by another user
    @ExceptionHandler(OptimisticLockException::class)
    fun handleOptimisticLockException(e: OptimisticLockException): ProblemDetail {
        val problemDetail = ProblemDetail.forStatus(HttpStatus.CONFLICT)
        problemDetail.title = "Conflict"
        problemDetail.detail = "The record was modified by another transaction. Please reload and try again."
        return problemDetail
    }
